...
test.describe('Language Switcher', () => {
  ...
  test('should show language switcher when NO_LANGUAGE_SWITCHER is false', async ({ page }) => {
  ...
  test('should hide language switcher when NO_LANGUAGE_SWITCHER is true', async ({ page }) => {
  ...
  test('should maintain other navbar functionality when language switcher is hidden', async ({ page }) => {
    ...
    const uploadButton = page.locator('a[href*="upload"], button:has-text("Upload")');
