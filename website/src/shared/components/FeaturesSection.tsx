      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card bg-base-100 shadow-md rounded-lg">
          <div className="card-body items-center text-center">
            ...
            <p>{t('features.featureEndToEndText')}</p>
          </div>
        </div>
        <div className="card bg-base-100 shadow-md rounded-lg">
          <div className="card-body items-center text-center">
            ...
            <p>{t('features.featureSelfDestructionText')}</p>
          </div>
        </div>
        <div className="card bg-base-100 shadow-md rounded-lg">
          <div className="card-body items-center text-center">
            ...
            <p>{t('features.featureOneTimeText')}</p>
          </div>
        </div>
        <div className="card bg-base-100 shadow-md rounded-lg">
          <div className="card-body items-center text-center">
            ...
            <p>{t('features.featureSimpleSharingText')}</p>
          </div>
        </div>
        <div className="card bg-base-100 shadow-md rounded-lg">
          <div className="card-body items-center text-center">
            ...
            <p>{t('features.featureNoAccountsText')}</p>
          </div>
        </div>
        <div className="card bg-base-100 shadow-md rounded-lg">
          <div className="card-body items-center text-center">
            ...
            <p>{t('features.featureOpenSourceText')}</p>
          </div>
        </div>
      </div>
    </div>
