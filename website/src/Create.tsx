      ...
      {uuid ? (
        <Result uuid={uuid} password={password} prefix="s" />
          ...
          <Form>
            ...
            <SpecifyPassword
              setSpecifyPassword={setSpecifyPassword}
...
export const SpecifyPassword = (
  props: {
    readonly specifyPassword: boolean;
    readonly setSpecifyPassword: React.Dispatch<React.SetStateAction<boolean>>;
    readonly password: string;
    readonly setPassword: React.Dispatch<React.SetStateAction<string>>;
  } & React.HTMLAttributes<HTMLElement>,
) => {
  const { t } = useTranslation();
  const { specifyPassword, setSpecifyPassword, password, setPassword } = props;
  ...
  return (
    <FormGroup>
      <Input
        type="checkbox"
        id="specify-password"
        onChange={() => setSpecifyPasswordAndUpdatePassword(!specifyPassword)}
